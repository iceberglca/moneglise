        ...
        <div class="login-content">
            ...
            <div class="login-form">
                <form  method="POST" action="{{ route('login') }}">
                    ...
                    <button type="submit" class="btn btn-success btn-flat m-b-30 m-t-30">{{ __('Se connecter') }}</button>
                    <div class="social-login-content">
                    </div>
                    <div class="register-link m-t-15 text-center">
                        <p>Vous n'avez pas de compte ? <a href="{{ route('register') }}"> S'inscrivez vous ici</a></p>
                    </div>
                </form>
            </div>
        </div>
